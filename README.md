...
- **Features**:
  ...
  - Now default model across Google products
...
- **Features**:
  - Create custom music in the Gemini app (750M+ users)
  - Generate 30-second tracks with custom cover art from text prompts or images
  - Advanced music generation capabilities with auto-lyrics and vocals
  - Generates vocals, lyrics, and instruments automatically
  - SynthID watermarking on all tracks
  - Custom cover art generation with Nano Banana
  - Available in 8 languages (English, German, Spanish, French, Hindi, Japanese, Korean, Portuguese)
- **Access**: Available in Gemini app for users 18+ in 8 languages
...
- **Features**:
  ...
  - Draws context from Gmail, Drive, and Chat in addition to the web
  - Transform reports into interactive content in Canvas
- **Availability**:
  - Gemini Advanced (desktop and mobile web) for open-web research
  - NotebookLM for research inside uploaded sources
  - Gemini API for developers (December 2025)
- **Developer Access**: Available via Gemini API with Interactions API (public beta)
- **Performance**: State-of-the-art on Humanity's Last Exam (HLE) and DeepSearchQA
...
**32. Learn Your Way (formerly Learn About)**
...
**42. Gemini for Google Workspace**
...
**43. Security AI Workbench & Gemini in Security Operations**
...
**46. AI features in Google Analytics 4**
...
**78. Speech, Text & Translation APIs**
- **Link**: https://cloud.google.com/products/ai
...
**87. Gemini Family (1.x / 2.x / 2.5 / 3.0 / 3.1)**
- **Link**: https://deepmind.google/models
...
**90. Gemini 3 Deep Think (Updated)**
...
**105. Immersive View in Google Maps**
...
**110. Dream Track & YouTube Music AI Tools**
...
**112. YouTube Deepfake Disclosure Tools**
...
**117. Google Essentials (Windows app)**
...
**119. Google AI Plus (around $7.99/month US)**
...
**120. Google AI Pro (around $19.99/month US)**
- **Link**: https://one.google.com/about/plans
...
**122. Enterprise / Workspace / Vertex SKUs**
