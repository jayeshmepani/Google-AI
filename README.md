...
- **Description**: Next-generation image generation model combining Pro quality with Flash speed
- **Features**:
  - High-quality image generation with faster results
...
- **Features**:
  ...
  - **Veo 3.1** (January 2026):
    - 4K output support
    - Vertical video generation for YouTube Shorts
...
- **Features**:
  ...
  - Updated interface for easier asset management
...
- **Description**: Most advanced music generation tool from Google
- **Features**:
  - Create custom music in the Gemini app
  - Generate 30-second tracks with custom cover art
  - Describe an idea or upload a photo/video to generate music
  - Advanced music generation capabilities
- **Access**: Available in Gemini app
- **Announced**: February 2026
...
- **Updates**: March 2026 - Added Cinematic Video Overviews feature
...
**79. Gemini Family (1.x / 2.x / 2.5 / 3.0 / 3.1)**
- **Link**: https://deepmind.google/models
...
**82. Gemini 3 Deep Think (Updated)**
